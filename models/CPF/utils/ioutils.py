...
def print_query(querylist, col=3, desp="Queries", align="c"):
    ...
    print("{}  {}  {}".format("=" * 30, desp, ">" * 30), "magenta")
...
def print_args(args):
    opts = vars(args)
    print("{}  Options  {}".format("=" * 30, ">" * 30), "yellow")
...
#             state[k] = v
#         else:
#             print(f'{k} is NOT in current model')
#     model_state.update(state)
#     model.load_state_dict(model_state)

#     print(f'loaded #epoch{epoch} from {checkpoint_pth}', 'cyan')
