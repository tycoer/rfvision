...
test_dataset_type = 'ArtiDetImgDataset'
test_data_root = 'data/real_data/' + category + '/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        ...
        ann_file=test_data_root + 'test_meta.txt',
        det_file=test_data_root + 'det_bboxes.json',
