...
data = dict(
    ...
    train=dict(
        type=[dataset_type] * 2,
        ann_file=[data_root + 'stapler/train.txt',
                  data_root + 'stapler_v2/train_meta.txt'],
        img_prefix=[data_root + 'stapler/',
                    data_root + 'stapler_v2/'],

        intrinsics_path=data_root + 'stapler/camera_intrinsic.json',
