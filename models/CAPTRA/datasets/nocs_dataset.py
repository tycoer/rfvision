...
from ..utils.nocs_data_process import base_generate_data, split_nocs_dataset, read_cloud
from ..utils.vis_utils import plot3d_pts
...
class CaptraNOCSDataset(NOCSDataset):
    CLASS = None
    def __init__(self,
                 root_dset,
                 obj_category,
                 ...
                 pipeline=None,
                 **kwargs):
        super(CaptraNOCSDataset, self).__init__(
            root_dset,
            obj_category,
            obj_info,
            num_expr,
    ...
    def __getitem__(self, item):
        results = super(CaptraNOCSDataset, self).__getitem__(item)
        if self.pipeline is not None:
