...
from ..utils.data_utils import farthest_point_sample, split_real_dataset
...
class SAPIENRealDataset:
    ...
    def collect_data(self, truncate_length):
        ...
        if not splits_ready:
            split_real_dataset(self.root_dset, self.obj_category, self.num_expr, self.obj_info['test_list'])
